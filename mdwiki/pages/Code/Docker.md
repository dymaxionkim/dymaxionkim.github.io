...
* 본 예제에서 사용된 Bitnami RedMine의 경우, 컨테이너를 Stop 했다가 다시 Start 시켜보니깐 다시 살아나는데 문제가 있는 듯 합니다.  재부팅이 안되므로 지속적으로 사용하기가 곤란하다는 이야기인데, 원인은 아직 규명하지 못했습니다.  이것 말고 다른 이미지들을 더 테스트해보고 적당한 것으로 골라야겠습니다.
